...
const HeaderNav = () => {
  ...
  return (
    <div className="w-[100%] bg-slate-700 top-0 fixed left-0 right-0 z-50">
      <Navbar fluid rounded className="w-[90%] mx-auto bg-slate-700 ">
        <Navbar.Brand  >
          <img src="/fitnessLogo.jpg" className="h-[20px] w-[20px] md:h-[30px] md:w-[30px]  border rounded-full" alt="" />
