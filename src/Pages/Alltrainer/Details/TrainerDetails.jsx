...
const TrainerDetails = () => {
    ...
    const { _id, name, email, socialIcon, image, age, skills,Class, available_days_a_week, Available_time, experience, description, hours } = trainer || {}
            ...
            <div className='w-[100%] flex flex-col'>
                ...
                <Card className="max-w-xl mx-auto">
                    <div className="flex flex-col items-center pb-10">
                        ...
                        <div className='grid '>
                            <h1 className='grid md:grid-cols-3 lg:grid-cols-4'>Skills:{skills?.map(i => <li className='list-none mx-1'>{i}</li>)}</h1>
                        </div>
                        <div>
                            Available_days_a_week:
                            <div className='grid md:grid-cols-3 lg:grid-cols-4'>{available_days_a_week?.map(item => <li className='list-none mx-1 text-xs font-medium border-2 p-1'>{item}</li>)}</div>
                        </div>
                        <div className=''>
