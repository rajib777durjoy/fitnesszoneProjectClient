    ...
    return (
        <div className="w-[100%]">
            ...
            <div className="w-[100%]">
                ...
                <Link to='allTrainerList'><li className="text-white border border-transparent hover:bg-slate-400 ps-4 py-4 list-none font-medium text-xl my-5">All Trainers</li></Link>
