        ...
        <div className='w-[100%] min-h-[500px] bg-slate-50 py-10'>
            ...
            <div className='w-[90%] mx-auto md:flex items-center justify-between  py-3 rounded-md my-4'>
                <div className='md:w-[35%] w-[100%]'>
                    <img src={aboutImg} alt="" className='w-[100%] md:h-[300px] h-[200px] rounded-md' />
                </div>
                <div className='md:w-[60%] w-[100%] ms-2'>
                    <p className='text-xl font-semibold'>Our fitness tracker is a cutting-edge device designed to help you take charge of your health and wellness. Whether you're a beginner or a fitness enthusiast, it empowers you to track, analyze, and improve your fitness journey effortlessly. Key features include</p>
