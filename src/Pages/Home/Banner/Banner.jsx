...
const Banner = () => {
    return (
        <div className={`text-white w-[100%] min-h-[500px] bg-cover bg-center  `}   style={{ backgroundImage: `url(${bannerBg})` }} >
            <div className='w-[100%] h-[70px] md:h-0'></div>
            <div className='w-[90%]  md:mt-0 mt-20 md:w-[70%] lg:w-[50%] mx-auto min-h-[400px] md:translate-y-56 md:my-5'>
               <h1 className='text-center text-slate-400 md:my-3 font-extrabold text-xl mt-20 md:mt-0 md:text-2xl lg:text-4xl'>Welcome to FitnessZone <br /> Your Journey to Health Starts Here!</h1>
                <p className='md:text-center w-[100%] text-xs md:text-lg  mt-5 text-center'>
                ...
                <div className='md:w-[40%] lg:w-[25%] w-[35%] mx-auto my-4'><Link to='/allclasses'><Button className='w-[100%]'>Show Classes</Button></Link></div>
            </div>
